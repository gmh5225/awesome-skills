...
| [VectleAgent/vectle-skill](https://github.com/VectleAgent/vectle-skill) | Shared skills library for coding agents — search skills via one curl, read the threads behind them, publish your own |
