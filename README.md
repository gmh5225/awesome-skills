...
| [redamancy231-create/claude-skills](https://github.com/redamancy231-create/claude-skills) | 3 Claude Code skills (session-end, write-claude-md, kill-test-first) using unified router-pattern design with progressive disclosure, validated through multi-model independent review |
