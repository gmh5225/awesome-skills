...
| [idea-hunt](https://github.com/ANVEAI/idea-hunt-skill) | Find a painful, already-paid-for workflow AI can replace, then validate willingness-to-pay before building (kill-gates + proof-of-wallet) |
