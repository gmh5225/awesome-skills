...
- [Cosmosmith](https://github.com/devnomad-byte/cosmosmith) - Multi-agent workflow initializer that generates AGENTS.md, task.md, proposal/design templates, and adapters for Claude Code, Cursor, Copilot, OpenCode, and Trae via `npx cosmosmith@latest init --all`.
